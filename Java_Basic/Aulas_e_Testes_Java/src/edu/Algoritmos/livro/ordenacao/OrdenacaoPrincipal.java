...
public class OrdenacaoPrincipal {
	...
	public static void main(String[] args) {
		...
		Item[] tabela = new Item[26];
		Item[] tabela2 = new Item[26];
		int[] des = { 0,8,40,45,7,6,9,12,15,16,34,32,38,14,24,26,28,27,92,1,20,29,25,29,65,3};
		...
		sequencia = ordS.ordPolifase(sequencia);
